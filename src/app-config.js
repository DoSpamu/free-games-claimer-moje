...
export const CONFIG_SCHEMA = [
  ...
  { path: 'notifications.tgToken',          env: 'TG_TOKEN',                   type: 'string',  default: '' },
  { path: 'notifications.tgChatId',         env: 'TG_CHAT_ID',                 type: 'string',  default: '' },
...
// aliexpress.active. Translate on disk whenever we see the legacy key.
...
// loop can re-read after a config save and reschedule without a panel restart.
